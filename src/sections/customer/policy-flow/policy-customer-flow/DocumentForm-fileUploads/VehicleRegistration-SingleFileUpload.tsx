...
const VehicleRegistrationSingleFileUpload = ({ error, file, setFieldValue, sx, ...other }: UploadProps) => {
  ...
  const onRemove = () => {
    setFieldValue('vehicleRegistrationFile', null);
  };
...
export default VehicleRegistrationSingleFileUpload;
