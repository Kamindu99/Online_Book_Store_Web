...
export interface ToolbarProps {
  ...
  onClickPrev: () => void;
  onClickToday: () => void;
  onClickAllHoliday: () => void;
  titleAllHoliday: string;
  onChangeView: (s: string) => void;
  sx?: GridProps['sx'];
}

const Toolbar = ({ date, view, onClickNext, onClickPrev, onClickToday, onClickAllHoliday, titleAllHoliday, onChangeView, sx, ...others }: ToolbarProps) => {
