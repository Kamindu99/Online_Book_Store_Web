...
const getInitialValues = (subagent: FormikValues | null) => {
    ...
    if (subagent) {
        return _.merge({}, newSubAgent, subagent);
    }
...
const CreateEditView = () => {
    const { actionType, subagentId } = useParams()
    ...
    }, [subagentId, actionType])

    const subagentCreateEditSchema = Yup.object().shape({
    ...
    const formik = useFormik({
        initialValues: getInitialValues(subagent!),
        validationSchema: subagentCreateEditSchema,
                                                ...
                                                <Grid container spacing={3}>
                                                    <Grid item xs={6} md={6}>
                                                        <Grid container spacing={3}>
                                                            <Grid item xs={12}>
                                                                <Stack spacing={1.25}>
                                                                    <InputLabel htmlFor="firstName">Sub Agent Name</InputLabel>
                                                                    <TextField
                                                                        fullWidth
                                                                        id="firstName"
                                ...
                                <Grid container justifyContent="space-between" alignItems="center">
                                    ...
                                    <Grid item>
                                        <Stack direction="row" spacing={2} alignItems="center">
                                            {actionType === 'create'
                                                ? <>
                                                    <Button color="error" onClick={() => { navigate(`/application/sub-agent-management/sub-agents`) }}>
                                                        Cancel
                                                    </Button>
