...
import TableHeader from 'sections/application/sub-agent-management/sub-agents/TableHeader';

// ==============================|| REACT TABLE FOR SUB AGENTS ||============================== //
...
const List = () => {
    ...
    const [subagent, setSubAgent] = useState(data);
                            ...
                            <Tooltip title="View">
                                <IconButton
                                    ...
                                    onClick={(e: MouseEvent<HTMLButtonElement>) => {
                                        ...
                                        let subagent = row.values.id;
                                        console.log(subagent);

                                        navigation(`/application/sub-agent-management/sub-agents/create-edit-view/view/${subagent}`)
    ...
    const handleAddEdit = () => {
        navigation(`/application/sub-agent-management/sub-agents/create-edit-view/create/null`)
    }
    return (
        <Grid container>
            <Grid item xs={12}>
